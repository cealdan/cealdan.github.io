(function (global) {
    const baseTranslations = {
        ...
        ja: {
            ...
            "aletheia-desc": "AIコンテンツ制作アプリ",
            "aletheia-date": "2025年春（停止中）",
            "aletheia-full": "物語の生成、架空世界の創造、イラスト制作を可能にするモバイル向けAIコンテンツ制作およびソーシャルアプリケーション。",
            "aletheia-intro": "<p>Aletheiaへようこそ。本プロジェクトは、創造性と人工知能の交差点を探求することを目的としています。このリポジトリには、アプリケーションの中核となる機能およびユーザー体験を表す、選定されたKotlinおよびXMLファイルが含まれています。なお、これは完全なプロジェクトではありません（一部のファイルは共有できませんでした）。また、現時点での一般公開を目的としたものではありません。</p><p>Aletheiaは、AIの支援を受けながら物語を紡ぎ、架空の世界を創造し、イラストを生成できるモバイルアプリケーションです。物語創作の想像力と、現代の機械学習ツールが持つ表現力を融合させ、ソーシャルメディアのダイナミクスに着想を得た、インタラクティブなプラットフォームを提供します。</p><p>本プロジェクトは開発途中（現在は一時停止中）であり、ここで共有されているファイルは、アプリのアーキテクチャおよび主要機能についての理解を深めるための参考資料としてのみ提供されています。</p><p>ご質問、ご意見、またはコラボレーションについてのご相談がありましたら、<a href=\"mailto:cealdan.dev@gmail.com\">cealdan.dev@gmail.com</a> までお気軽にご連絡ください。</p><p>ご関心とご理解に感謝いたします。</p><p>本プロジェクトはデモンストレーション目的のみで共有されています。すべての権利は留保されています。著者の明示的な許可なしに、コードの一部または全部を再利用、複製、再配布することは禁止されています。</p>",
