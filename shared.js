(function (global) {
    const baseTranslations = {
        fr: {
            ...
            "aletheia-intro": "<p>Bienvenue sur Aletheia — un projet visant à explorer l'intersection de la créativité et de l'intelligence artificielle. Ce dépôt contient des fichiers Kotlin et XML sélectionnés qui représentent la fonctionnalité principale et l'expérience utilisateur de l'application. Veuillez noter que ce n'est pas le projet complet, et il n'est pas destiné à être open-source ou distribué publiquement à ce moment.</p><p>Aletheia est une application mobile conçue pour permettre aux utilisateurs de créer des histoires, d'inventer des mondes fictifs et de générer des illustrations visuelles pour eux avec l'aide de l'IA. Elle combine le potentiel imaginatif de la création narrative avec les capacités expressives des outils d'apprentissage automatique modernes, le tout dans une plateforme socialement interactive inspirée de la dynamique des réseaux sociaux.</p><p>Le projet est actuellement en développement actif, et ces fichiers partagés sont destinés uniquement à fournir un aperçu de l'architecture de l'application et des fonctionnalités principales.</p><p>Si vous avez des questions, des commentaires ou souhaitez discuter d'une collaboration potentielle, n'hésitez pas à nous contacter par email à <a href=\"mailto:cealdan.dev@gmail.com\">cealdan.dev@gmail.com</a>.</p><p>Merci pour votre intérêt et votre compréhension.</p><p>Ce projet est partagé à des fins de démonstration uniquement. Tous droits réservés. La réutilisation, la reproduction ou la redistribution de toute partie du code n'est pas autorisée sans autorisation explicite de l'auteur.</p>",
